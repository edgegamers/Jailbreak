...
public class PlayerTagHelper : IRichPlayerTag, IPlayerTag
{
    ...
    public PlayerTagHelper(IServiceProvider provider)
    {
        ...
        _wardenService = new Lazy<IWardenService>(() => provider.GetRequiredService<IWardenService>());
        _rebelService = new Lazy<IRebelService>(() => provider.GetRequiredService<IRebelService>());
        _specialTreatmentService =
            new Lazy<ISpecialTreatmentService>(() => provider.GetRequiredService<ISpecialTreatmentService>());
    }
