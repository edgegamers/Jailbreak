...
public interface IJihadC4Service
{
    ...
    /// the +use key is pressed when the bomb is equipped it will blow up and 
    /// physically blast the Terrorists as well as damage the Guards in a certain radius.
    /// </summary>
    /// <param name="terrorist"></param>
    public void GiveJihadC4ToTerrorist(CCSPlayerController terrorist);

    /// <summary>
    /// The function that should actually do all the calculations for blowing up the 
    /// "Jihad C4". This function should also obviously only work if the supplied player
    /// controller actually has the "Jihad C4" and is holding it out. 
    /// </summary>
    /// <param name="terrorist"></param>
